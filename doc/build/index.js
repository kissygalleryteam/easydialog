...
kg/easydialog/2.0.0/confirm
kg/easydialog/2.0.0/prompt
kg/easydialog/2.0.0/index
 ...
 * @module easydialog
 **/
KISSY.add('kg/easydialog/2.0.0/confirm',function(S,Base,Node,Common){
	var $ = Node.all;
 ...
 * @module easydialog
 **/
KISSY.add('kg/easydialog/2.0.0/prompt',function(S,Base,Node,Common){
	var $ = Node.all;
 ...
 * @module easydialog
 **/
KISSY.add('kg/easydialog/2.0.0/index',function(S,Alert,Confirm,Prompt){
    return {
        alert:Alert,
        confirm:Confirm,
        prompt:Prompt
